                    ...
                    <td>
                        <div class="button-container">
                            <form action="{{ route('view.reservation', $reservation->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('GET')
                                <button type="submit" id="reservations-view-btn">
                                ...
                                @if ($reservation->status === 'Pending')
                                <form action="{{ route('assign.reservation', $reservation->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('GET')
                                    <button class="success" type="submit" id="reservations-confirm-btn">
                                ...
                                <form action="{{ route('cancel.reservation', $reservation->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('PUT')
                                    <button class="danger" type="submit" id="reservations-cancel-btn">

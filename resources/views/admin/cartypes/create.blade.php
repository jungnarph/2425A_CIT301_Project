...
@section('main_panel')
    ...
    <div class="container-fluid">
        <form action="{{ route('store.cartype') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="type_name">Car Type Name</label>
                <input type="text" class="form-control" id="type_name" name="type_name" placeholder="Enter car type name" required>
            </div>
            
            <div class="form-group">
                <label for="insurance_fee">Insurance Fee</label>
                <input type="text" class="form-control" id="insurance_fee" name="insurance_fee" placeholder="Enter insurance fee" required>
            </div>

...
@auth
    ...
    <nav id="sidebar">
        <ul>
            ...
            <li class="active">
                <a href="/admin/dashboard" class="nav-link {{ request()->routeIs('admin')?'active':'' }}">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <div>
                        <li><a href="/admin/cars/create">Car</a></li>
                        <li><a href="/admin/carmodels/create">Car Model</a></li>
                        <li><a href="/admin/users/create">User</a></li>
                    </div>
                </ul>
            </li>
            <li>
                <a href="/admin/cars/manage" class="nav-link {{ request()->routeIs('admin.cars.manage')?'active':'' }}">
            ...
            <li>
                <a href="/admin/carmodels/manage" class="nav-link {{ request()->routeIs('manage.carmodel')?'active':'' }}">
            ...
            <li>
                <a href="/admin/users/manage" class="nav-link {{ request()->routeIs('admin.users.manage')?'active':'' }}">
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a href="/logout" class="nav-link text-danger" onclick="event.preventDefault(); this.closest('form').submit();">

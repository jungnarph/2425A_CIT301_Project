...
@auth
    ...
    <nav id="sidebar">
        <ul>
            ...
            <li class="{{ request()->routeIs('manage.car')?'active':'' }}">
                <a href="/admin/cars/manage" class="">
            ...
            <li class="{{ request()->routeIs('manage.carmodel')?'active':'' }}">
                <a href="/admin/carmodels/manage" class="">
            ...
            <li class="{{ request()->routeIs('admin.users.manage')?'active':'' }}">
                <a href="/admin/users/manage" class="">

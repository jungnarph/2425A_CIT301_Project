...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto"> <!-- All items on the right -->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/login">Fleet</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/login">Services</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('login') }}">
                            <i class="bi bi-person" style="margin-right:0.5rem;"></i>Login
                        </a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="welcome-container">
        ...
        <h2 style="color: white; font-size: 40px;">Car rental services</h2>
        <br>
        ...
        <button type="button" style="width: 40%; border-radius: 10px; border: solid white 0.5px; color: white; padding: 10px" class="main-button">
            Rent cars now
        </button>
    </div>
